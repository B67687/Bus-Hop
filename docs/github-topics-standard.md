...
| bus-hop           | `bus-hop`, `kotlin`, `android`, `jetpack-compose`, `transit`, `bus-arrival`           |
| traffic-dashboard | `traffic-dashboard`, `github-traffic`, `badges`, `analytics`, `web`                   |
| 2002-Combat       | `2002-combat`, `java`, `game`, `retro`, `2d`                                          |

### Forks

| Repo  | Topics                                         |
| ----- | ---------------------------------------------- |
| Scoop | (skip — unmodified fork, keep original topics) |
